                                        ...
                                        <div className="institute-preview col-sm-4" key={ institute.instituteId }>
                                                ...
                                                <MDBRipple rippleColor='light' rippleTag='div' className='bg-image hover-overlay'>
                                                        ...
                                                        <MDBCardBody>
                                                                ...
                                                                <div className="row">
                                                                <MDBBtn btn color='success' onClick={()=>editInstitute(institute)}>Edit</MDBBtn><pre>  </pre>
                                                                <MDBBtn btn color='danger' onClick={()=>deleteInstitute(institute.instituteId)}>Delete</MDBBtn>
                                                                </div>
                                                        </MDBCardBody>
                                                </MDBCard>
                                        </div>
