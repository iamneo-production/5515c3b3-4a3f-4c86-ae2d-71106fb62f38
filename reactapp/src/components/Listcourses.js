                                ...
                                <div className="course-preview col-sm-4" key={ course.courseId }>
                                        ...
                                        <MDBRipple rippleColor='light' rippleTag='div' className='bg-image hover-overlay'>
                                                ...
                                                <MDBCardBody>
                                                        ...
                                                        <MDBCardText>
                                                                Duration : { course.courseDuration } Hours
                                                        </MDBCardText>
                                                        <div className="row">
                                                                <div className="col-sm-4">
                                                                        <MDBBtn btn color='success' onClick={()=>editCourse(course)}>Edit</MDBBtn>
                                                                </div>
                                                                <div className="col-sm-4">
                                                                        <MDBBtn btn color='danger' onClick={()=>deleteCourse(course.courseId)}>Delete</MDBBtn>
                                                                </div>
